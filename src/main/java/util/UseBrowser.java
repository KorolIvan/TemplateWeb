...
public class UseBrowser {
    ...
    private static final String IE_DRIVER_PATH = "src/main/resources/driver/IEDriverServer.exe";
    private static final String FIREFOX_DRIVER_PATH = "src/main/resources/driver/geckodriver_winX64.exe";

    //path for linux os
    private static final String FIREFOX_DRIVER_PATH_LINUX = "src/main/resources/driver/geckodriver";
    private static final String CHROME_DRIVER_PATH_LINUX = "src/main/resources/driver/chromedriver";
